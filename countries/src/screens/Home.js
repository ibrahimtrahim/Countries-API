...
function Home() {
  ...
  return (
    ...
    <section className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
      <input type="text" id="search-navbar" className="block w-2/5 p-2 ps-10 text-sm text-gray-900 rounded-md shadow bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for a country..." />
      <div>
